...
from app.scrapes.youtube import YouTubeScraper, ChannelVideo
from app.scrapes.openai import OpenAIScraper, OpenAIArticle
from app.scrapes.anthropic import AnthropicScraper, AnthropicArticle
...
if __name__ == "__main__":
    results = run_scrappers(hours=500)
